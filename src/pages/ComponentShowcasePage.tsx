 ...
 * 
 * Demonstrates all the components in the library.
 */
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <Section title="Buttons">
            ...
            <Stack direction="horizontal" gap="md" wrap="wrap" className="mt-4">
            ...
            <Box className="grid md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    This is a card description with some helpful text.
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          {/* Layout Components */}
          <Section title="Layout (Box & Stack)">
            <Stack gap="md">
          ...
          <Section title="Accordion">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  This is a reusable component library built with React, Tailwind
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  Absolutely. The components use CSS variables from our design
          ...
          >
            <Text textColor="muted">
              Component Library v1.0 • Built with React + Vite + Tailwind CSS v4 +
              Radix UI
            </Text>
          </footer>
        </div>
